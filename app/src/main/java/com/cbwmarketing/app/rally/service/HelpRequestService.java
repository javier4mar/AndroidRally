...
import com.cbwmarketing.app.rally.model.HelpRequest;
...
import com.cbwmarketing.app.rally.view.MapFragment;
...
public class HelpRequestService extends Service implements ValueEventListener {
    ...
    public static final String SERVICE_ACTION = "com.cbwmarketing.app.rally.service.HelpRequestService.SERVICE";
